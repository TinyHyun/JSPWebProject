...
<div id="top" style="border:0px solid #000;"> 
	...
	<ul id="lnb">
		...
		%>
		<li><a href="../main/logOut.jsp" onclick="return confirm('로그아웃을 하시겠습니까?');"><img src="../images/lnb05.gif" alt="LOG OUT" /></a></li>
		<li><a href="../center/.jsp"><img src="../images/lnb06.gif" alt="MODIFY" /></a></li>
